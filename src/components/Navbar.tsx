      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="h-20 flex items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex items-center gap-2.5 sm:gap-4 md:gap-6 lg:gap-8 overflow-x-auto no-scrollbar py-2">
            ...
            <a 
              href="/#reviews"
              className="text-[11px] sm:text-xs font-semibold text-bone/80 hover:text-clay transition-colors uppercase tracking-wider sm:tracking-[0.18em] whitespace-nowrap px-1.5 py-1 flex items-center gap-1.5"
            >
              <span>Reviews</span>
            </a>
            <a 
